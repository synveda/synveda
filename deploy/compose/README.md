...
For source prerequisites, focused tests and the code map, start with the
[developer guide](../../docs/DEVELOPMENT.md). This guide owns the complete
source-deployment lifecycle and optional modes.
