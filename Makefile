...
# These targets prepare and revalidate the immutable, content-free candidate
# for CPR-45's later disposable-Engine run. They never create a provider,
# contact Docker or mutate the privileged development resolver mapping.
compose-clean-engine-plan:
	deploy/compose/scripts/clean-engine-acceptance.sh plan

compose-clean-engine-status:
	deploy/compose/scripts/clean-engine-acceptance.sh status

compose-clean-engine-verify:
	deploy/compose/scripts/clean-engine-acceptance.sh verify
...
check-deploy: check-release-parity check-chart-images
	...
	node --test scripts/clean-engine-live-provider-effect-generation.test.mjs
	node --test scripts/clean-engine-live-provider-effect.test.mjs
	node --test scripts/clean-engine-live-provider-effect-fixture-adapter.test.mjs
	node --test scripts/clean-engine-live-provider-effect-fixture-blueprint.test.mjs
	node --test scripts/compose-entrypoints.test.mjs scripts/check-host-resolution.test.mjs scripts/manage-hosts-file.test.mjs scripts/check-network-preflight.test.mjs scripts/check-compose-assets.test.mjs scripts/check-build-proxy-contract.test.mjs scripts/check-local-builder.test.mjs scripts/clean-engine-receipts.test.mjs scripts/clean-engine-state.test.mjs scripts/clean-engine-background-state.test.mjs scripts/clean-engine-provider-process-contract.test.mjs scripts/check-cpr-45-four-role-boundary.test.mjs scripts/cpr-45-four-role-fixture.test.mjs scripts/clean-engine-colima-live-contract.test.mjs scripts/clean-engine-provider-adapter-registry.test.mjs scripts/clean-engine-live-provider-plan.test.mjs scripts/clean-engine-live-provider-intent.test.mjs scripts/clean-engine-live-provider-start-decision.test.mjs scripts/clean-engine-live-provider-process-start.test.mjs scripts/clean-engine-live-provider-reservation.test.mjs scripts/compose-browser-login.test.mjs scripts/run-with-deadline.test.mjs scripts/check-runtime-smoke.test.mjs scripts/reset-runtime-state.test.mjs scripts/compose-lifecycle.test.mjs
...
check-compose-contract:
	...
	node --test scripts/clean-engine-live-provider-effect-fixture-adapter.test.mjs
	node --test scripts/clean-engine-live-provider-effect-fixture-blueprint.test.mjs
	node --test scripts/compose-entrypoints.test.mjs scripts/check-host-resolution.test.mjs scripts/check-network-preflight.test.mjs scripts/check-compose-assets.test.mjs scripts/check-build-proxy-contract.test.mjs scripts/check-local-builder.test.mjs scripts/clean-engine-receipts.test.mjs scripts/clean-engine-state.test.mjs scripts/clean-engine-background-state.test.mjs scripts/clean-engine-provider-process-contract.test.mjs scripts/check-cpr-45-four-role-boundary.test.mjs scripts/cpr-45-four-role-fixture.test.mjs scripts/clean-engine-colima-live-contract.test.mjs scripts/clean-engine-provider-adapter-registry.test.mjs scripts/clean-engine-live-provider-plan.test.mjs scripts/clean-engine-live-provider-intent.test.mjs scripts/clean-engine-live-provider-start-decision.test.mjs scripts/clean-engine-live-provider-process-start.test.mjs scripts/clean-engine-live-provider-reservation.test.mjs scripts/compose-browser-login.test.mjs scripts/run-with-deadline.test.mjs scripts/check-runtime-smoke.test.mjs scripts/reset-runtime-state.test.mjs scripts/compose-lifecycle.test.mjs
	node scripts/check-compose-contract.mjs
