...
check-release-parity:
	node --test scripts/check-release-parity.test.mjs scripts/install.test.mjs scripts/build-kind-image.test.mjs scripts/verify-release-images.test.mjs scripts/release-registries.test.mjs scripts/consumer-compose.test.mjs
