...
99 features parsed from docs/SYNVEDA_FEATURES.md — one file per
...
- [ ] Prompts 3–33 — filed by the prompts that run them (see §9 of the implementation record for the ordering this baseline commits to).
