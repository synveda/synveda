...
103 features parsed from docs/SYNVEDA_FEATURES.md — one file per
...
- [ ] Prompts 7–33 — filed by the prompts that run them (see §9 of the implementation record for the ordering this baseline commits to, and §10 for where a prompt's own text diverged from it).
