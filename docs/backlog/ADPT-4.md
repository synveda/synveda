...
That checkout also called its API `0.2.0`; the number alone could not identify
a compatible server. The 2026-09-20 product version preparation now targets
API `0.3.0`, with local drift and installed-package checks recorded in the
[SDK guide](../../sdks/README.md#compatibility-and-release-boundary).
No test against the published product was run.
