...
Captured manual and automatic compaction emit `PreCompact`, `PostCompact` and, before the
...
manual/auto trigger vocabulary. Both paths have native 0.152.0 evidence;
deterministic replay remains separate from the recorded live qualification.
