...
| [ADR-0105](adr-0105-direct-compose-acceptance.md) | Direct Docker Compose acceptance | Accepted | Current | CPR-45 | Supersedes ADR-0103/0104 and removes container-engine simulation. Logical recovery is the reference path; Operations, Apalis and live upgrade/external acceptance remain CPR-45, while S3/WAL-PITR stays with OPS-5. |
