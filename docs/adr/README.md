...
| [ADR-0065](adr-0065-release-and-distribution.md) | Release packaging and distribution | Accepted; amended eight times | Current (partially superseded by ADR-0102) | OPS-8 | Native/plugin/chart packaging remains; the digest-bound Docker reference and environment manifest replace its installed-profile mechanics. |
