...
| [ADR-0119](adr-0119-session-checkpoints-from-verified-ledger-evidence.md) | Checkpoints derived from immutable Session evidence | Current (rollout evidence pending) | CTX-6; deterministic Claude compact/restart replay passes, while live task quality, capture and policy/retention probes remain open. |
