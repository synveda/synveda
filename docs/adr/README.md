...
| [ADR-0117](adr-0117-client-platform-boundaries.md) | Client platform and private-state boundaries | Accepted; amended once | Current (credential candidate) | OPS-12 | CLI/hooks share path fixtures; Windows credentials gain native ACL/identity/replacement checks. Other non-Unix private state and deployment witnesses still refuse. |
