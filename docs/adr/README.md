...
| [ADR-0107](adr-0107-copilot-context-adapter.md) | Experimental Copilot context adapter | Accepted | Current | ADPT-9 | Extends ADR-0106's closed client identity and retains ADR-0098 qualification gates; native frames are captured but full lifecycle qualification remains open. |
