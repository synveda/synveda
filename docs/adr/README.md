...
| [ADR-0113](adr-0113-static-public-site-and-brand.md) | Static public site and canonical brand | Accepted | Current | FND-7 | Public HTML/CSS and derived assets are isolated from the product runtime; Pages publication and account identity remain owner actions. |
