...
| [ADR-0065](adr-0065-release-and-distribution.md) | Release packaging and distribution | Accepted; amended nine times | Current (partially superseded by ADR-0102) | OPS-8, CPR-39 | Native/plugin/chart packaging remains, including the existing Codex runtime; the digest-bound Docker reference and environment manifest replace its installed-profile mechanics. |
...
| [ADR-0107](adr-0107-copilot-context-adapter.md) | Experimental Copilot context and observations | Accepted; amended | Current | ADPT-9 | Captured native text/tool events reuse the shared bounded reader and spool; runtime exit flushes without task closure. Full native lifecycle qualification remains open under ADR-0098. |
