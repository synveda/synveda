...
| [ADR-0065](adr-0065-release-and-distribution.md) | Release packaging and distribution | Accepted; amended ten times | Current (partially superseded by ADR-0102) | OPS-8, CPR-39, ADPT-9 | Native/plugin/chart packaging remains, including the existing Codex and Copilot runtimes; the digest-bound Docker reference and environment manifest replace its installed-profile mechanics. |
...
| [ADR-0115](adr-0115-prebuilt-container-release-verification.md) | Prebuilt container release verification | Accepted | Current (hosted verification pending) | OPS-8, CPR-45, OPS-11 | Native anonymous digest pulls and executable checks gate release announcements; the existing archive provides server-only installation. |
