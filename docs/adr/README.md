...
| [ADR-0065](adr-0065-release-and-distribution.md) | Release packaging and distribution | Accepted; amended twelve times | Current (partially superseded by ADR-0102) | OPS-8, CPR-39, ADPT-9, OPS-12 | Native/plugin/chart packaging remains; private Node and Unix client archives extend distribution without server downloads. Exact native plugin scope is preserved. The digest-bound reference replaces installed-profile mechanics. |
