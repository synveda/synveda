...
eval_clear_db_test_environment() {
  unset SYNVEDA_DB_TEST_MAIN_DATA_NETWORK SYNVEDA_DB_TEST_LIFECYCLE_DATA_NETWORK
  unset SYNVEDA_DB_TEST_MAIN_HOST_NETWORK SYNVEDA_DB_TEST_LIFECYCLE_HOST_NETWORK
